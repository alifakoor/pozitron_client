...
var _hoisted_1 = { role: "tablist" };
var _hoisted_2 = { class: "p-steps-number" };
var _hoisted_3 = { class: "p-steps-title" };
    ...
    createVNode("ul", _hoisted_1, [
      (openBlock(true), createBlock(Fragment, null, renderList($props.model, (item, index) => {
        return openBlock(), createBlock(Fragment, {
          ...
          $options.visible(item) ? (openBlock(), createBlock("li", {
            key: 0,
            ...
            !_ctx.$slots.item ? (openBlock(), createBlock(Fragment, { key: 0 }, [
          ...
          ], 14, ["aria-selected", "aria-expanded"])) : createCommentVNode("", true)
        ], 64);
      }), 128))
    ])
  ], 10, ["id"]);
...
var steps_esm_default = script;

// dep:primevue_steps
var primevue_steps_default = steps_esm_default;
export {
